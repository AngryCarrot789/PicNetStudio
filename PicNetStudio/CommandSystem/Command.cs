...
/// </para>
/// <para>
/// These commands can be executed through the <see cref="CommandManager.Execute(string,PicNetStudio.CommandSystem.Command,PicNetStudio.Interactivity.Contexts.IContextData,bool)"/> function
/// </para>
/// </summary>
