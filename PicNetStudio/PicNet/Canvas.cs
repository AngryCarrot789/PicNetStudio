...
public delegate void CanvasSizeChangedEventHandler(Canvas canvas, PixSize oldSize, PixSize newSize);
...
public class Canvas {
    ...
    public void ReadFromRBE(RBEDictionary data) {
        this.size = data.GetStruct<PixSize>("CanvasSize");
