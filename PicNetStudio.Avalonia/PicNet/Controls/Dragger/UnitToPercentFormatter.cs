...
public class UnitToPercentFormatter : IValueFormatter {
    ...
    /// </summary>
    public static UnitToPercentFormatter Standard => new UnitToPercentFormatter(2, 6);
    ...
    public UnitToPercentFormatter() {
    }

    public UnitToPercentFormatter(int nonEditingRoundedPlaces, int editingRoundedPlaces) {
