...
public abstract class BaseCanvasTool : ITransferableData {
    ...
    public virtual bool OnCursorPressed(Document document, SKPointD relPos, SKPointD absPos, int count, EnumCursorType cursor, KeyModifiers modifiers) {
        return false;
    }
    ...
    public virtual bool OnCursorReleased(Document document, SKPointD relPos, SKPointD absPos, EnumCursorType cursor, KeyModifiers modifiers) {
        return false;
    }
